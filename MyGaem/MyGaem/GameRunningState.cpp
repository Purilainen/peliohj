    ...
    , m_batch(0)
{
    ...
    m_newTexture = new yam2d::Texture("test.png");
...
bool GameRunningState::update(yam2d::ESContext *context, float deltaTime)
{
    ...
    if (m_totalTime <= 3.0f)
    {
        ...
        m_newTexture->setTransparentColor(255, 255, 255);
        m_batch->addSprite(m_newTexture, m_sprite, yam2d::vec2(0, 0), m_totalTime * 2, yam2d::vec2(600, 400));
    }
    else
    {
